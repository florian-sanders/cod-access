...
const LegalNotice = () => (
  <>
    <section className="LegalNotice">
      ...
      <p className="LegalNotice__description">Conformément aux dispositions des articles 6-III et 19 de la Loi n° 2004-575 du 21 juin 2004 pour la Confiance dans l'économie numérique, dite L.C.E.N., nous portons à la connaissance des utilisateurs et visiteurs du site : www.codaccess.com les informations suivantes :</p>

      <h2 className="LegalNotice__subTitle">1. Informations légales :</h2>
      <p className="LegalNotice__description">
        Statut du propriétaire : particulier
        Le Propriétaire est : team a11y
        Adresse postale du propriétaire : in the cloud 75000 paris
<br></br>
Le Créateur du site est : a11y-team.com
Le Responsable de la  publication est : a11y-team
Contacter le responsable de la publication : cod.access11@gmail.com
Le responsable de la publication est une personne physique
<br></br>
Le Webmaster est  : a11y-team
Contacter le Webmaster :  cod.access11@gmail.com
L’hebergeur du site est : aws amazon 75000 paris</p>

      <h2 className="LegalNotice__subTitle">2. Présentation et principe :</h2>
      <p className="LegalNotice__description">
...
Team a11y s’efforce de fournir sur le site www.codaccess.com des informations les plus précises possibles (sous réserve de modifications apportées depuis leur mise en ligne), mais ne saurait garantir l'exactitude, la complétude et l'actualité des informations diffusées sur son site, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations. En conséquence, l'utilisateur reconnaît utiliser ces informations données (à titre indicatif, non exhaustives et susceptibles d'évoluer) sous sa responsabilité exclusive.
      ...
      <h2 className="LegalNotice__subTitle">3. Accessibilité :</h2>
      <p className="LegalNotice__description">
      ...
      <h2 className="LegalNotice__subTitle">4. Propriété intellectuelle :</h2>
      <p className="LegalNotice__description">
        team a11y est propriétaire exclusif de tous les droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, tant sur la structure que sur les textes, images, graphismes, logo, icônes, sons, logiciels…<br></br>
Toute reproduction totale ou partielle du site www.codaccess.com, représentation, modification, publication, adaptation totale ou partielle de l'un quelconque de ces éléments, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de team a11y, propriétaire du site à l'email : cod.access11@gmail.com, à défaut elle sera considérée comme constitutive d’une contrefaçon et passible de poursuite conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>


      <h2 className="LegalNotice__subTitle">5. Liens hypertextes et cookies :</h2>
      <p className="LegalNotice__description">
...
Le paramétrage du logiciel de navigation permet d’informer de la présence de cookie et éventuellement, de la refuser de la manière décrite à l’adresse suivante : www.cnil.fr. <br></br>L’utilisateur peut toutefois configurer le navigateur de son ordinateur pour refuser l’installation des cookies, sachant que le refus d'installation d'un cookie peut entraîner l’impossibilité d’accéder à certains services. Pour tout bloquage des cookies, tapez dans votre moteur de recherche : bloquage des cookies sous IE ou firefox et suivez les instructions en fonction de votre version.</p>

      <h2 className="LegalNotice__subTitle">6. Protection des biens et des personnes - gestion des données personnelles :</h2>
      <p className="LegalNotice__description">
...
Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout utilisateur dispose d’un droit d’accès, de rectification, de suppression et d’opposition aux données personnelles le concernant. <br></br>Pour l’exercer, adressez votre demande à www.codaccess.com par email : cod.access11@gmail.com ou par écrit dûment signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.<br></br>
...
Le site www.codaccess.com est en conformité avec le RGPD voir notre politique RGPD  pas de rgpd.</p>
      <p className="LegalNotice__description">
