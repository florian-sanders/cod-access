    ...
    <div className="signup__content">
      ...
      <form action="" method="get" className="signup__content__form">
        <div className="signup__content__form__group">
          ...
          <input type="email" name="email" id="email" required className="signup__content__form__group__input" />
        </div>
        <div className="signup__content__form__group">
          <label hmtlFor="pseudo" className="signup__content__form__group__label">Pseudo</label>
          <input type="text" name="pseudo" id="pseudo" required className="signup__content__form__group__input" />

        </div>
        <div className="signup__content__form__group">
          <label hmtlFor="password" className="signup__content__form__group__label">Mot de passe</label>
          <input type="password" name="password" id="password" required className="signup__content__form__group__input" />
        </div>
        <div className="signup__content__form__group">
          <label hmtlFor="password_confirm" className="signup__content__form__group__label">Confirmez votre mot de passe</label>
          <input type="password" name="password_confirm" id="password_confirm" required className="signup__content__form__group__input" />
        </div>
        <div className="signup__content__form__group">
